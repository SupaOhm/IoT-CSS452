...
const char* ClientID = "Client_Node1_YourStudentID";
const char* TopicPub = "IoT/PotenValue_Node1_YourStudentID";
const char* TopicSub = "IoT/PotenValue_Node2_YourStudentID";
long lastMsg = 0;
...
void loop() {
  ...
  if (now - lastMsg > 2000) {
    ...
    ClientESP.publish(TopicPub, Val);
    Serial.print("Pub: ");
    Serial.println(Val);
  }
}
