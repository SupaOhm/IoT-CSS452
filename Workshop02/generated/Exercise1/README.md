# Exercise1 — Exercise 2: ESP32 Multitasking and Deep Sleep
...
`Exercise1.ino` is a verbatim transcription of the instructor's `Ex_Interrupts.ino`
...
3. Open `Exercise1/Exercise1.ino` and upload. Press the PROGRAM button if the output window sits
   at `Connecting…`.
