# Exercise1 — Exercise 1: Introduction to ESP32
...
`Exercise1.ino` is a verbatim transcription of the instructor's `Digital_InOut.ino`
...
3. Open `Exercise1/Exercise1.ino` and upload. If the output window shows `Connecting…`, press the
