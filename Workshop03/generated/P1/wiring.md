# P1 wiring — Homework 3 Problem 1 (Lecture Note 5, Section 4)

Source: `Lecture Note 5 - ESP32 - Web Servers and Clients.pdf`, slide 76
(the same circuit is drawn on slides 70 and 71).

No LEDs and no buttons. The only hardware is the potentiometer.
...
| Part | Value | Source |
| --- | --- | --- |
| Potentiometer | value not stated in the material | slide 76 schematic |
